...
## Project Structure
    ...
    ├── studioappwithname_d_50756  # Django project configurations
...
1. Clone this repo and `cd studioappwithname_d_50756`
...
2. Clone this repo and `cd studioappwithname_d_50756`
